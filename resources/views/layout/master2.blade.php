...
<div class="icon-bar-sticky">
  ...
  <header class="top-bar dualbar left-menu">
      <div class="topbar">
          <div class="top-bg">
              <div class="container">
                  <div class="row justify-content-end">
                        ...
                        <div class="d-lg-flex d-block">
                          <div class="topbar-social text-center text-md-left topbar-left">
                            <ul class="list-inline d-md-flex d-inline-block">						  			  
                               <li class="ml-lg-10 pr-10">
                                  <div class="btn-group">
                                    <button class="btn btn-rounded btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Language</button>
                               ...
                               <li class="ml-10 pr-10">
                                  <div class="btn-group">
                                    <button class="btn btn-rounded btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Currency</button>
                                    <div class="dropdown-menu">
                    ...
                    <div class="col-lg-5 col-md-6 col-12 xs-mb-10">
                        ...
                        <ul class="list-inline d-md-flex justify-content-end">				  
                           <li class="mr-10 pl-10 lng-drop">
                              <select class="header-lang-bx selectpicker">
                                  <option data-icon="flag-icon flag-icon-us">English USA</option>
                                  <option data-icon="flag-icon flag-icon-gb">English UK</option>
                              </select>
                           </li>
                           <li class="mr-10 pl-10"><a href="#"><i class="text-white fa fa-user"></i> Register</a></li>
                           <li class="mr-10 pl-10"><a href="#"><i class="text-white fa fa-sign-in"></i> Login</a></li>
                        </ul>
                      </div>
                    </div>
                   </div>
          ...
          <div class="middlebar d-lg-block d-none">
            <div class="container">
              <div class="row">
                <div class="col-6">
                    <div class="d-lg-flex d-block">
                      <div class="logo">
                          <a href="index.html" class="brand d-lg-block d-none">
                              <img src="{{ URL::asset('assets/images/logo-light-text2.png') }}" alt=""/>
                          </a>
                      </div>
                    </div>
                </div>
                <div class="col-6">
                  <div class="topbar-social text-center text-md-right topbar-right">
                    <ul class="list-inline d-md-flex justify-content-end">
                      <li class="mr-10 pl-10"><a href="#"><span class="ti-facebook"></span></a></li>
                      <li class="mr-10 pl-10"><a href="#"><span class="ti-instagram"></span></a></li>
                      <li class="mr-10 pl-10"><a href="#"><span class="ti-twitter-alt"></span></a></li>
                    </ul>
                  </div>
                </div>
               </div>
      ...
      <nav hidden class="nav-white nav-transparent">
                  ...
                  <div class="megamenu-content">
                      <div class="row">
                          ...
                          <div class="col-md-3 col-12 d-none d-lg-block">
                              <img src="{{ URL::asset('assets/images/front-end-img/adv.jpg') }}"  class="img-fluid" alt="" />
                          </div>
                      </div>
                  </div>
              </li>				
          ...
          <ul class="attributes">
              <li class="d-md-block d-none"><a href="#" class="px-10 py-5"><div class="btn btn-danger py-5">Enroll Now</div></a></li>
              ...
              <li class="megamenu" data-width="270">
                  ...
                  <div class="megamenu-content megamenu-cart">
                      ...
                      <div class="cart-body">
                          <ul>
                              <li>
                                  <img src="{{ URL::asset('assets/images/product/product-1.png') }}" alt="">
                              ...
                              <li>
                                  <img src="{{ URL::asset('assets/images/product/product-2.png') }}" alt="">
                                  <h5 class="title">Lorem ipsum dolor</h5>
                                  <span class="qty">Quantity: 02</span>
                                  <span class="price-st">$843,12</span>
                                  <a href="#" class="link"></a>
                              ...
                              <li>
                                  <img src="{{ URL::asset('assets/images/product/product-3.png') }}" alt="">
                                  <h5 class="title">Lorem ipsum dolor</h5>
                                  <span class="qty">Quantity: 02</span>
                                  <span class="price-st">$843,12</span>
                                  <a href="#" class="link"></a>
  ...
  <!---page Title --->
   <section class="bg-img pt-130 pb-50" data-overlay="7" style="background-image: url(assets/images/front-end-img/banners/banner-5.jpg); background-position: top center;">
		<div class="container">
			<div class="row">
				<div class="col-12">
					...
					<div class="text-center">
						<a href="{{url('/login')}}" class="btn btn-outline text-white">INICIO DE SESION REQUERIDO</a>
					</div>
				</div>
			</div>
		</div>
    ...
    @endguest
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="widget widget_gallery clearfix">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/1.jpg') }}"  alt=""></li>
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/2.jpg') }}"  alt=""></li>
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/3.jpg') }}"  alt=""></li>
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/4.jpg') }}"  alt=""></li>
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/5.jpg') }}"  alt=""></li>
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/6.jpg') }}"  alt=""></li>
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/7.jpg') }}"  alt=""></li>
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/8.jpg') }}"  alt=""></li>
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/9.jpg') }}"  alt=""></li>
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/10.jpg') }}"  alt=""></li>
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/11.jpg') }}"  alt=""></li>
                                        <li><img src="{{ URL::asset('assets/images/gallery/thumb/12.jpg') }}"  alt=""></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-3 col-12">
                ...
                <div class="footer-bottom bg-dark3">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6 col-12 text-md-left text-center"> © 2020 <span class="text-white">EduAdmin</span>  All Rights Reserved.</div>
        ...
        <script type="text/javascript" src="{{ URL::asset('assets/vendor_components/OwlCarousel2/dist/owl.carousel.js') }}"></script>
