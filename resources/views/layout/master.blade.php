              ...
              <li class="megamenu" data-width="270">
                  ...
                  <div class="megamenu-content megamenu-cart">
                      ...
                      <div class="cart-body">
                          <ul>
                              <li>
                                <img src="{{ URL::asset('assets/images/front-end-img/product/product-1.png') }}" alt="">
                              ...
                              <li>
                                <img src="{{ URL::asset('assets/images/front-end-img/product/product-2.png') }}" alt="">
                                  <h5 class="title">Lorem ipsum dolor</h5>
                                  <span class="qty">Quantity: 02</span>
                                  <span class="price-st">$843,12</span>
                                  <a href="#" class="link"></a>
                              ...
                              <li>
                                <img src="{{ URL::asset('assets/images/front-end-img/product/product-3.png') }}" alt="">
                                  <h5 class="title">Lorem ipsum dolor</h5>
                                  <span class="qty">Quantity: 02</span>
                                  <span class="price-st">$843,12</span>
                                  <a href="#" class="link"></a>
